        ...
        <div className="md:flex justify-center gap-10 mt-3">
          ...
          >
            <div className="flex justify-end items-start m-1 space-x-2">
              <a
                href="https://github.com/rkang427/TSA"
                target="_blank"
              ...
              <a
                href="https://thescholarshipacademy2025report.vercel.app/"
                target="_blank"
                rel="noopener noreferrer"
              >
            ...
            <div className="mx-2 mb-3">
              ...
              <p className="m-2 font-light text-xs">
                A non-profit dashboard for school, district, and statewide
                impact.
              </p>
            </div>
          </Box>
          ...
          >
            <div className="flex justify-end items-start m-1 space-x-2">
              <a
                href="https://github.com/rkang427/crAIvings"
                target="_blank"
                rel="noopener noreferrer"
              >
                <CodeIcon className="align-right rounded-full  hover:border-pine hover:text-lime   border-darkGray ml-auto  " />
              ...
              <a
                href="https://craivings.vercel.app/"
                target="_blank"
                rel="noopener noreferrer"
              >
                <ArrowOutwardIcon className="align-right rounded-full bg-lime   border-darkGray ml-auto hover:bg-lightGray" />
            ...
            <div className="m-1">
              ...
              <p className="mx-2 font-light text-xs">
                Serverless DB recommending restaurants based on token.
              </p>
            </div>
          </Box>
        </div>
